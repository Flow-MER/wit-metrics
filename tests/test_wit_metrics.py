...
def test_load_batch_robustness(tmp_path):
...
def test_time_since_last_inundation_simple():
    """
    ...
    result = time_since_last_inundation(wit_data, wit_im)
...
def test_adaptive_inundation_threshold_p30():
    ...
    result = adaptive_inundation_threshold(df, min_threshold=0.05, max_threshold=0.5)
